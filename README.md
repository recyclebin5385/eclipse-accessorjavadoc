...
Select the getter and setter methods and click **OK** to add or overwrite the Javadoc comments for the selected methods.
...
If the regular expression does not match the field name, the field name will be used as-is and prefixes or suffixes will not be removed.
